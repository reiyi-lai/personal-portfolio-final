          ...
          <Col xs={12} md={6} xl={7}>
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I am Rachel – a`}</h1> 
                <h1><span className="txt-rotate" dataPeriod="700" data-rotate='[ "web developer", "product enthusiast", "full-time eater" ]'><span className="wrap">{text}</span></span></h1> 
